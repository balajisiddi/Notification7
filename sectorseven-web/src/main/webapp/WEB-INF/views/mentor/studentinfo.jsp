<div class="mg-content" id="mg-content"
  ...
  $(document).ready(function(){
	  getAllStudentsUnderMentor();
  });
  function getAllStudentsUnderMentor(){
	    $.ajax({
	        type : "GET",
	        ...
	        success : function(data) {
	      	  var table =$('<div class="row"/>').appendTo($('#studentinfodiv'));
	      	  if(data.response.length==0){
	      		table.append("No Data"); 
	      	  }
	      	  $.each(data.response, function(i, student) {
	      		var tab=$('<div class="col-sm-6 col-md-4 col-xl-3">').appendTo(table);
	      		tab.append($('<div class="bgsuccess">'+
	              '<div class="row">'+
	                '<div class="col-sm-4 col-lg-4 col-xl-4">'+
	                  '<div class="how-img">'+
	                  '  <img src="${pageContext.request.contextPath}/studt/getImageUrl?type=askStudent&userId='+student.id+'&imgPath='+student.imgPath+'&imgName='+student.imgName+'"'+
